...
public class pengembalianForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Pastikan Data Yang Anda Masukan Benar");
        ...
        pinjamButton.setText("Kembalikan");
        pinjamButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pinjamButtonActionPerformed(evt);
            }
        });
        jPanel1.add(pinjamButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 410, 100, 30));
    ...
    Library_System obj = new Library_System();
    ...
    private void pinjamButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pinjamButtonActionPerformed
        ...
        if (Judul.getText().equals("Si Kancil")&&
            ...
            JOptionPane.showMessageDialog(null, "Terimakasih, Telah Membaca");
            obj.panggilmenu();
            this.setVisible(false);
        } 
